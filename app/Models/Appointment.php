...
class Appointment extends Model
{
    ...
    public function toCalendarArray(): array
    {
        ...
        return [
            ...
            'service' => $this->service_name ?? $this->service?->title ?? 'Услуга удалена',
            'duration' => (int) ($this->duration ?? $this->service?->duration_minutes ?? 0),
            'price' => (float) ($this->price ?? $this->service?->price ?? 0),
